  ...
  return (
    <main className="flex h-screen flex-col items-center justify-center p-4 bg-zinc-50">
      <form className="max-w-sm w-full rounded-lg h-96 shadow-lg flex flex-col gap-5 p-8 bg-white items-center">
        <h1>{`{ Repobrain }`}</h1>
        <input type="text" placeholder="Insira o seu email" className="w-full border border-zinc-300 p-2 rounded-lg" />
        <input type="text" placeholder="Insira a sua senha" className="w-full border border-zinc-300 p-2 rounded-lg" />
